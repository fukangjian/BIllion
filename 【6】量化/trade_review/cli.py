...
from compliance_check import run_compliance_check, report_to_markdown
from config import ACCOUNT_EQUITY, DRAWDOWN_STATE
from metrics import compute_stats, enrich_trade_metrics, group_by_account, group_by_strategy, stats_to_markdown
from report_generator import generate_monthly_report, generate_weekly_report
...
def cmd_update(args):
    ...
    # 自动计算 R 倍数
    if trade.is_closed:
        from metrics import calc_r_multiple
