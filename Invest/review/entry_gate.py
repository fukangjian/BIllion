...
from review.compliance_check import Violation, check_risk_cluster, check_single_trade
...
def check_entry(
    ...
    portfolio = log.list_all(open_only=True) + [trade]
    violations.extend(check_risk_cluster(portfolio, account_equity=account_equity))
